...
$help   = ($r=$conn->query("SELECT COUNT(*) t FROM help_requests")) ? $r->fetch_assoc()['t'] : 0;
    ...
    <div class="right">
        ...
        <div class="cards">
            ...
            <div class="card orange">
                🛠️ Help Requests
                <h1><?php echo $help; ?></h1>
                <a href="admin_help.php">View Details</a>
            </div>

            <div class="card full-width download-card">
                📄 Download Logs
                <h2>Certificate PDF Records</h2>
                <p>Track which user downloaded which certificate with date & time.</p>
                <a href="pdf_logs.php">View Logs</a>
            </div>
